        ...
        <div className="rules-mask" onClick={() => setShowRules(false)}>
          <section className="rules-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="rules-content">
              ...
              <p>6. 好友需要通过邮箱添加，添加成功后可在“好友抢位”中看到对方真实车位状态。</p>
              <p>7. 好友车位占用规则：先计算好友自有车辆占位，再计算外来车辆占位；总占位达到车位上限后不可再抢位。</p>
              <p>8. 你只能停放自己的空闲车辆到好友车位；停入后该车在自己车场不可重复停放，取回后才可再次调度。</p>
              <p>9. 停在好友车位的车辆享受更高收益，但车况损耗也更快；请根据收益和保养成本做平衡。</p>
              <p>10. 好友互动排行榜当前按“抢位次数”计分（抢位越多分越高），全服排行榜按综合资产评分。</p>
              <p>11. 所有核心数据均保存在服务器，登录同一账号可跨设备同步。</p>
            </div>
          </section>
        </div>
      )}
